...
const opacity = (turns_left, num) => {
  if(turns_left <= num) return "1"
  else return "0.1"
}

function Gallows(props) {
  const { turns_left } = props
    ...
    <svg id="drawing"
     ...
     viewBox="0 0 460.9899 548.03535">
      ...
      <g transform="translate(-27.2 -220)">
        ...
        <path id="rope"
              style={{opacity: opacity(turns_left, 6), fill: '#a28d5d', stroke: '#a28d5d'}}
        ...
        <path id="post"
              style={{fill: '#c27207', stroke: '#c27207'}}
              d="m192 220c2.46 52.1 9.2 104 4.99 156 3.68 33.9 4.84 68.4
        ...
        <path id="arm1"
              style={{opacity: opacity(turns_left, 0), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="arm2"
              style={{opacity: opacity(turns_left, 1), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="leg1"
              style={{opacity: opacity(turns_left, 2), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="leg2"
              style={{opacity: opacity(turns_left, 3), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="body"
              style={{opacity: opacity(turns_left, 4), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="head"
              style={{opacity: opacity(turns_left, 5), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
