    ...
    <svg id="drawing"
     ...
     viewBox="0 0 460.9899 548.03535">
      ...
      <g transform="translate(-27.2 -220)">
        ...
        <path id="rope"
              style={{opacity: turn(left, 6), fill: '#a28d5d', stroke: '#a28d5d'}}
        ...
        <path id="arm1"
              style={{opacity: turn(left, 0), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="arm2"
              style={{opacity: turn(left, 1), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="leg1"
              style={{opacity: turn(left, 2), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="leg2"
              style={{opacity: turn(left, 3), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="body"
              style={{opacity: turn(left, 4), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
        ...
        <path id="head"
              style={{opacity: turn(left, 5), fill: '#777', stroke: '#777', strokeWidth: '3.5'}}
